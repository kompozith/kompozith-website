...
export class OrderComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.seoService.updateMetaTags(
      "Kompozith | Simulez et passez votre commande en ligne",
      "Utilisez notre outil de simulation et passez votre commande en ligne rapidement et en toute sécurité. Obtenez une estimation de prix immédiate et personnalisez vos besoins avec Kompozith.",
      "Combien coûte un site web au Cameroun, Combien coûte une application web, Prix de développement d'un site internet, Tarifs de création de site web, Combien coûte un site e-commerce, Prix d'une application mobile sur mesure, Coût de création de site vitrine, Combien coûte un site web professionnel, Tarifs de développement d'application web, Estimation du prix d'un site internet, Coût de développement web Cameroun."
    );
  ...
  onSubmit() {
    ...
    if (!this._orderHelper.cmd_services.length) {
      this._httpResponseService.response = {
        status: false,
        message: "notification.order.empty",
      };
      return;
    }
    this.loading = true;
    ...
    this._orderService
      ...
      .then(() => {
        ...
        this._httpResponseService.response = {
          status: true,
          message: "notification.order.sent.success",
        };
        // const data = {
        //   email:this.orderForm.value.email,
      ...
      .catch((err: any) => {
        ...
        this._httpResponseService.response = {
          status: false,
          message: "notification.order.sent.error",
        };
      });
  }
